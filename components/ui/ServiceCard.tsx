  ...
  return (
    <Link
      ...
      className={`block rounded-2xl p-6 transition-all duration-300 group ${
        featured
          ? 'border-2 border-[#C49A2C] bg-[#C49A2C]/5 hover:shadow-lg'
          : 'bg-white border border-[#E5E2D9] hover:border-[#C49A2C] hover:shadow-md'
      }`}
    >
      <div className="w-12 h-12 rounded-xl bg-[#C49A2C]/10 flex items-center justify-center mb-4 group-hover:bg-[#C49A2C]/20 transition-colors duration-300">
        <div className="text-[#C49A2C] w-6 h-6 group-hover:text-[#A6821E] transition-colors duration-300 [&>svg]:w-6 [&>svg]:h-6">
          {icon}
        </div>
      </div>
