...
import { SIDING_SOFT_METALS_FAQS as FAQS } from '@/lib/faqs/sidingSoftMetals'
    ...
    >
      <div className="mx-auto" style={{ maxWidth: '1320px' }}>
        <div className="relative flex flex-col items-center text-center mb-10 md:mb-14 max-w-[960px] mx-auto">
          ...
          >
            Siding &amp; Soft Metals Questions, Answered
          </h2>
          <p
            className="mt-6 max-w-[460px] text-brand-slate leading-[1.7]"
            style={{
              fontSize: '16px',
              fontFamily: 'var(--font-inter), system-ui, sans-serif',
              fontWeight: 400,
          ...
          >
            Straight answers from your local Red Seal certified siding contractor in Cochrane.
          </p>
          <div className="mt-8">
