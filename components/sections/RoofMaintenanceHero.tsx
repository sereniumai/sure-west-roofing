        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative mt-8 lg:mt-0 lg:order-1 order-2">
            ...
            <div className="relative overflow-hidden rounded-[18px]"
              ...
              <div className="relative" style={{ height: '440px' }}>
                <Image
                  src="/images/Cochrane Roofing Contractor Gallery 15.webp"
                  alt="Sure West Roofing Red Seal Journeyman performing annual roof maintenance in Cochrane Alberta"
                  fill
            ...
            <div className="mt-7 flex items-center justify-around" style={{ paddingRight: '8px' }}>
              {[
                { value: 'From $250', label: 'Annual Visit' },
                { value: '5.0 ★', label: 'Google Rating' },
                { value: '+25%', label: 'Roof Lifespan' },
              ].map(({ value, label }) => (
          ...
          <div className="lg:order-2 order-1">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-4 gap-y-2"
              ...
              <span>Warranty-Extending Care</span>
              <span aria-hidden="true" style={{ color: '#D4AF60' }}>·</span>
