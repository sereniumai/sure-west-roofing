  ...
  return (
    <section className="bg-[#F7F7F4] py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col gap-6">
            {rest.map((testimonial, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-7 shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_12px_rgba(0,0,0,0.04)] flex-1"
                initial={{ y: 30, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true, margin: '-50px' }}
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white rounded-full px-5 py-2.5 shadow-[0_1px_3px_rgba(0,0,0,0.06),0_4px_12px_rgba(0,0,0,0.04)]">
