      ...
      <div className="max-w-[1320px] mx-auto">
        ...
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex items-center gap-2"
            ...
            <li><Link href="/" className="hover:text-brand-gold transition-colors duration-200">Home</Link></li>
            ...
            <li aria-hidden="true" className="text-brand-border select-none">/</li>
            <li className="text-brand-navy font-medium" aria-current="page">Skylight Installation</li>
          </ol>
        </nav>
        </Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative overflow-hidden rounded-[18px]"
              ...
              <div className="relative h-[280px] sm:h-[360px] lg:h-[440px]">
                ...
                <div aria-hidden="true" className="absolute inset-0 pointer-events-none"
                  style={{ background: 'linear-gradient(to top, rgba(44,71,102,0.28) 0%, transparent 40%)' }} />
              </div>
            </div>

            <div className="mt-7 flex items-center justify-around" style={{ paddingRight: '8px' }}>
              {[
                { value: '100+', label: 'Skylights Installed' },
                { value: '5.0 ★', label: 'Google Rating' },
                { value: '5 yr', label: 'Leak Warranty' },
              ].map(({ value, label }) => (
                <div key={label} className="flex flex-col items-center text-center">
                  <span className="font-display font-semibold text-brand-gold"
                    style={{ fontSize: '22px', letterSpacing: '-0.02em', lineHeight: 1 }}>{value}</span>
                  <span className="mt-1 text-brand-slate"
                    style={{ fontSize: '11px', fontFamily: 'var(--font-inter), system-ui, sans-serif', fontWeight: 400, letterSpacing: '0.02em' }}>{label}</span>
                </div>
              ))}
            </div>
          </Reveal>
          ...
          <div className="lg:order-2 order-1">
            ...
            <span className="inline-flex items-center px-4 py-2 uppercase tracking-[0.1em] rounded-[6px] mb-6 text-brand-gold"
              ...
              Cochrane&apos;s Skylight Installation Specialists
            </span>
            </Reveal>
            ...
            <p className="mt-5 text-brand-slate leading-[1.65] max-w-[480px]"
              ...
              Red Seal certified skylight installation for Cochrane, Calgary, and Canmore.
              Velux and Fakro brands, leak-free flashing systems, written 5-year leak warranty.
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-4 gap-y-2"
              ...
              <span>5-Year Leak Warranty</span>
              <span aria-hidden="true" style={{ color: '#D4AF60' }}>·</span>
              <span>Permit Handled</span>
            </div>
            </Reveal>
          </div>
        </div>
