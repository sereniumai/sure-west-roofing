        ...
        <span
          ...
          style={
            sectionBg.toUpperCase() === '#F7F5F0'
              ? { background: '#FFFFFF', fontSize: '12px', fontFamily: "var(--font-inter), system-ui, sans-serif", fontWeight: 600, lineHeight: 1 }
              : { background: '#F7F5F0', fontSize: '12px', fontFamily: "var(--font-inter), system-ui, sans-serif", fontWeight: 600, lineHeight: 1 }
          }
        >
          Client Reviews
        </span>
