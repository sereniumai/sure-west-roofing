      ...
      <div className="max-w-[1320px] mx-auto">
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex items-center gap-2"
            ...
            <li aria-hidden="true" className="text-brand-border select-none">/</li>
            <li className="text-brand-navy font-medium" aria-current="page">Roof Inspection</li>
          </ol>
        </nav>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Content LEFT, Image RIGHT (default order) */}
          <div>
            <span className="inline-flex items-center px-4 py-2 uppercase tracking-[0.1em] rounded-[6px] mb-6 text-brand-gold"
              ...
              Cochrane&apos;s Trusted Roof Inspection Specialists
            </span>
            ...
            <p className="mt-5 text-brand-slate leading-[1.65] max-w-[480px]"
              ...
              Red Seal certified roof inspection for Cochrane, Calgary, and Canmore. Pre-purchase,
              post-storm, and annual inspections with a written photo report. Book online or call
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="mt-7 flex items-center justify-around" style={{ paddingRight: '8px' }}>
              {[
                { value: '200+', label: 'Inspections Done' },
