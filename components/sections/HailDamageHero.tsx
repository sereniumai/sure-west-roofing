...
export function HailDamageHero() {
  return (
    <ServicePageHero
      ...
      h1={'Hail Damage Roof\nRepair in Cochrane'}
      body="Red Seal Journeyman hail damage roof repair in Cochrane, Calgary, and Canmore. Post-storm inspection, photo documentation, and a written diagnosis. Same standard, claim or out of pocket."
      image={{
