    ...
    >
      <div className="max-w-[1320px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Image, LEFT on desktop (alternates with Roof Replacement) */}
          <Reveal delay={250} noBlur className="relative mt-8 lg:mt-0 lg:order-1 order-2">
            ...
            <div className="mt-7 flex items-center justify-around" style={{ paddingRight: '8px' }}>
              {[
                { value: 'Same Wk', label: 'Repair Response' },
                { value: '5.0 ★', label: 'Google Rating' },
                { value: '2 yr', label: 'Repair Warranty' },
              ].map(({ value, label }) => (
          ...
          <div className="lg:order-2 order-1">
            ...
            >
              Cochrane&apos;s Trusted Roof Repair Specialists
            </span>
            </Reveal>
            ...
            >
              Red Seal certified roof repair for Cochrane, Calgary, and Canmore. Fast diagnosis,
              fixed written quotes, and a real warranty on every job. We pride ourselves on
              getting back to you quickly.
            </p>
            </Reveal>
