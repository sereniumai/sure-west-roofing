...
const ITEMS: IncludedItem[] = [
  ...
  },
  {
    ...
    body: 'Every Sure West siding project comes with a written workmanship guarantee, layered on top of the manufacturer warranty that protects the materials themselves. Both are spelled out in your written quote before any work begins. Two layers of accountability, neither hidden in fine print.',
  },
]

const SERIF = "Georgia, 'Times New Roman', serif"

export function SidingWhatIncluded() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-10 lg:gap-16 items-center">
          ...
          <Reveal>
            <div className="flex flex-col lg:order-1">
              ...
              >
                Every Sure West siding project covers more than the panels you see. Three things
                make a Cochrane install last, all in every quote.
              </p>
