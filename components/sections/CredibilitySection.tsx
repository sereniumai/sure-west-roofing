      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Badge overlay */}
            <div className="absolute bottom-8 left-8 bg-[#1B3558] text-white rounded-2xl p-6 border-l-4 border-[#E8922A]">
              <div className="font-display font-bold text-4xl text-[#E8922A] tracking-wide">
                {badgeNumber}
              </div>
          ...
          >
            ...
            <div className="mt-10 grid grid-cols-2 gap-6">
              {stats.map((stat) => (
                ...
                >
                  <div className="font-display font-bold text-3xl text-[#E8922A] tracking-wide">
                    {stat.number}
                  </div>
