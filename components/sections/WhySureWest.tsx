    ...
    >
      ...
      <div className="relative max-w-[1320px] mx-auto">
        ...
        <div className="mt-14 md:mt-20 grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,600px)] gap-12 lg:gap-20 items-start">
          {/* LEFT: pillars (static, always-visible) */}
          <motion.ul
            className="max-w-[540px] divide-y divide-[--color-near-black]/10 border-y border-[--color-near-black]/10"
          ...
          >
            {pillars.map((p, i) => (
              ...
              >
                ...
                <p
                  className="mt-3 pl-8 md:pl-9 text-[--color-near-black]/70 leading-[1.7]"
                  style={{
                    fontSize: '15px',
                    fontFamily: "'Inter', system-ui, sans-serif",
                    fontWeight: 400,
