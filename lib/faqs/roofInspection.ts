...
export const ROOF_INSPECTION_FAQS: FaqItem[] = [
  {
  ...
  },
  {
    ...
    answer:
      'A full exterior walk of every shingle slope, inspection of all flashing, vents, valleys, and penetrations, an attic check from inside the home where accessible, photo documentation of every checkpoint, and a written report with repair recommendations and a quote for any work needed.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Common triggers in Cochrane include buying or selling a home, after a hail or windstorm, when the roof passes 10 years old without an inspection, when an insurance carrier requests one, and as part of annual maintenance. Sure West can advise on whether you actually need an inspection during the booking call.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Sure West regularly produces inspection reports for Alberta home insurance claims, particularly hail and wind damage. The report includes the documentation, photos, and itemised quote your insurer requires. We can speak directly with your adjuster on request.',
  },
  {
    question: 'Should I get an inspection before buying a Cochrane home?',
    answer:
      'Yes, especially if the roof is over 10 years old or shows signs of wear from the ground. A Sure West pre-purchase roof inspection costs a fraction of a surprise post-close repair and gives you negotiating leverage if work is needed. Most general home inspectors do not climb the roof.',
  },
  {
