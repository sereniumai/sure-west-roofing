...
const LOCATIONS = [
  ...
  { name: 'Calgary', href: '/roofing-contractor-calgary', detail: 'Siding and soft metals across the Calgary region', buttonLabel: 'Roofing Contractor Calgary' },
  { name: 'Canmore', href: '/roofing-contractor-canmore', detail: 'Coverage across the Bow Valley', buttonLabel: 'Roofing Contractor Canmore' },
]
    ...
    >
      <div className="max-w-[1320px] mx-auto">
        <div className="flex flex-col items-center text-center mb-12 md:mb-16 max-w-[720px] mx-auto">
          ...
          >
            Siding &amp; Soft Metals Across Cochrane, Calgary, and Canmore
          </h2>
          <p
            className="mt-5 max-w-[580px] text-brand-slate leading-[1.7]"
            style={{
...
export default function SidingSoftMetalsPage() {
  return (
    <>
      ...
      <ServiceTypes />
      <WhySureWest />
      <ServicesGallery images={SSM_GALLERY_IMAGES} sectionBg="#F7F5F0" />
