...
const LOCATIONS = [
  ...
  { name: 'Calgary', href: '/calgary-roofing-contractor', detail: 'Siding and soft metals across the Calgary region', buttonLabel: 'Roofing Contractor Calgary' },
  { name: 'Canmore', href: '/canmore-roofing-contractor', detail: 'Coverage across the Bow Valley', buttonLabel: 'Roofing Contractor Canmore' },
]
