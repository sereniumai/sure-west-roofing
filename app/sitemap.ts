...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/calgary-roofing-contractor`,  lastModified, changeFrequency: 'weekly',  priority: 0.95 },
    { url: `${baseUrl}/canmore-roofing-contractor`,  lastModified, changeFrequency: 'weekly',  priority: 0.95 },
