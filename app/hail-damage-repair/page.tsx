...
const HAIL_CATEGORIES = [
  ...
  { tier: 'Severe Hail', name: 'Structural Damage', image: '/images/Structural Hail Damage.jpg', imageAlt: 'Aerial view of severe structural hail damage with plywood roof deck exposed', body: 'Golf-ball or larger hail compromises the entire roof system. Most insurers approve a full replacement at this severity, often using Class 4 impact-rated shingles to reduce risk and qualify the home for future premium discounts.' },
]
