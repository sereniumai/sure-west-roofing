...
const LOCATIONS = [
  ...
  { name: 'Calgary', href: '/roofing-contractor-calgary', detail: 'Hail claims across the Calgary region', buttonLabel: 'Roofing Contractor Calgary' },
  { name: 'Canmore', href: '/roofing-contractor-canmore', detail: 'Storm coverage across the Bow Valley', buttonLabel: 'Roofing Contractor Canmore' },
]
